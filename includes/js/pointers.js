( function($, MAP) {
    ...
    MAP.setPlugin = function( data ) {
        jQuery('#overlay').show();
        var mo_saml_support_layout=jQuery('#mo_saml_support_layout');
        var select_your_idp = jQuery('#select_your_idp');
        var test_your_idp = jQuery('#test_config');
        var upload_metadata = jQuery('#upload-metadata');
