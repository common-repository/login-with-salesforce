...
class mo_options_enum_pointers extends BasicEnum{
	public static $SERVICE_PROVIDER = array('custom_admin_pointers4_8_52_miniorange-support-pointer',
		'custom_admin_pointers1_0_0_miniorange-select-your-idp',
		'custom_admin_pointers1_0_0_miniorange-upload-metadata',
		'custom_admin_pointers1_0_0_miniorange-test-configuration',
		'custom_admin_pointers1_0_0_miniorange-import-config',
		'custom_admin_pointers1_0_0_export-import-config',
		'custom_admin_pointers1_0_0_configure-service-restart-tour');
	public static $IDENTITY_PROVIDER = array(
		'custom_admin_pointers1_0_0_metadata_manual',
		'custom_admin_pointers1_0_0_miniorange-sp-metadata-guide',
		'custom_admin_pointers1_0_0_miniorange-sp-metadata-url',
		'custom_admin_pointers1_0_0_identity-provider-restart-tour'
		);
	public static $ATTRIBUTE_MAPPING = array(
		'custom_admin_pointers1_0_0_miniorange-attribute-mapping',
		'custom_admin_pointers1_0_0_miniorange-role-mapping',
		'custom_admin_pointers1_0_0_attribute-mapping-restart-tour');
	public static $REDIRECTION_LINK = array(
		'custom_admin_pointers1_0_0_minorange-use-widget',
		'custom_admin_pointers1_0_0_miniorange-auto-redirect',
		'custom_admin_pointers1_0_0_miniorange-auto-redirect-login-page',
		'custom_admin_pointers1_0_0_miniorange-short-code',
		'custom_admin_pointers1_0_0_miniorange-redirection-sso-restart-tour'
		);
...
class mo_options_plugin_constants extends  BasicEnum{
     const CMS_Name = "WP";
     const Application_Name = "Login with SalesForce";
