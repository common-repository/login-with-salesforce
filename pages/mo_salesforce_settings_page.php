...
include 'mo_salesforce_licensing_plans.php';
include 'mo_salesforce_addons.php';
...
function mo_register_saml_sso()
{
    ...
    if ($active_tab == 'licensing') {
        ?>
                    ...
                    Login into Salesforce</div>
                    
                    <div style="float:left;"><a  class="add-new-h2 add-new-hover" style="font-size: 16px; color: #000;" href="<?php
        echo add_query_arg(array('tab' => 'save'), htmlentities($_SERVER['REQUEST_URI']));
        ?>"><span class="dashicons dashicons-arrow-left-alt" style="vertical-align: bottom;"></span> Back To Plugin Configuration</a></div>
                    ...
                    <br />
                    <?php mo_saml_salesforce_display_sale_banner();?>
        ...
        ?>
                ...
                Login into Salesforce&nbsp
                <a id="license_upgrade" class="add-new-h2 add-new-hover" style="background-color: orange !important; border-color: orange; font-size: 16px; color: #000;" href="<?php
    ...
    if ($active_tab != 'licensing') {
        ?>
                ...
                <tr>
                    <h2 class="nav-tab-wrapper">
                        ...
                        <a class="nav-tab <?php
        echo $active_tab == 'sp_setup' ? 'nav-tab-active' : '';
        ?>"
                           href="<?php
        echo add_query_arg(array('tab' => 'sp_setup'), htmlentities($_SERVER['REQUEST_URI']));
        ?>">Service Provider Setup</a>
                        <a class="nav-tab <?php
        echo $active_tab == 'sp_metadata' ? 'nav-tab-active' : '';
        ?>"
                           href="<?php
        echo add_query_arg(array('tab' => 'sp_metadata'), htmlentities($_SERVER['REQUEST_URI']));
        ?>">Service Provider Metadata</a>
                        <a class="nav-tab <?php
        echo $active_tab == 'attribute_role' ? 'nav-tab-active' : '';
        ?>"
                           href="<?php
        echo add_query_arg(array('tab' => 'attribute_role'), htmlentities($_SERVER['REQUEST_URI']));
        ?>">Attribute/Role
                            Mapping</a>
                        <a class="nav-tab <?php
        ...
        ?>"
                           href="<?php
        echo add_query_arg(array('tab' => 'general'), htmlentities($_SERVER['REQUEST_URI']));
        ?>">Redirection & SSO Links</a>
                        <a class="nav-tab <?php
        echo $active_tab == 'addons' ? 'nav-tab-active' : '';
        ?>"
                           href="<?php
        echo add_query_arg(array('tab' => 'addons'), htmlentities($_SERVER['REQUEST_URI']));
        ?>">Add-Ons</a>
                        <a class="nav-tab <?php
        echo $active_tab == 'support' ? 'nav-tab-active' : '';
        ?>"
                           href="<?php
        echo add_query_arg(array('tab' => 'support'), htmlentities($_SERVER['REQUEST_URI']));
        ?>">Feature Request</a>
                        <a class="nav-tab <?php
        echo $active_tab == 'account-setup' ? 'nav-tab-active' : '';
        ?>"
                           href="<?php
        echo add_query_arg(array('tab' => 'account-setup'), htmlentities($_SERVER['REQUEST_URI']));
        ?>">Account Setup</a>
...
function mo_show_customer_details()
{
    ...
    echo get_option('mo_saml_admin_email');
    ?></td>
                </tr>
                <tr>
                        ...
                        <table class="mo_saml_settings_table">
                            <tr>
                                ...
                                <td><input class="mo_saml_table_textbox" type="email" name="email"
                                           ...
                                           value="<?php
    echo get_option('mo_saml_admin_email') == '' ? get_option('admin_email') : get_option('mo_saml_admin_email');
    ?>"/>
                                </td>
                            </tr>
                            <tr>
            ...
            <form name="f" method="post" action="<?php
    echo add_query_arg(array('tab' => 'config'), htmlentities($_SERVER['REQUEST_URI']));
    ?>" id="mo_saml_continue_guest">
    ...
    if (mo_is_customer_registered_saml()) {
        ...
        <div style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 2% 0px 2%;position: relative" id="minorange-use-widget">
            ...
            <div style="margin:2% 0 2% 17px;">
                ...
                <div id="mo_saml_add_widget_steps">
                    <ol>
                        <li>Go to Appearances > <a href="<?php
        echo get_admin_url() . 'widgets.php';
        ?>">Widgets.</a></li>
                        <li>Select "Login with <?php
        ...
        <div style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 2% 0px 2%;position: relative" id="miniorange-auto-redirect">
            <h3>Option 2: Auto-Redirection from site<sup style="font-size: 12px;">[Available in <a
                        href="<?php
        echo admin_url('admin.php?page=mo_saml_settings&tab=licensing');
        ?>">Standard, Premium and Enterprise</a> plans]</sup></h3>
        ...
        ?></b></code><br /><br/>
            ...
            <br/><br/><input type="checkbox" style="background: #DCDAD1;" disabled><span style="color: red;">*</span> Checking
                        ...
                        <br/><i>(Note down this URL: <code><b><?php
        echo site_url();
        ?>
    ...
    <table width="98%" border="0" style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:2%;padding-top: 0px">
        ...
        <tr>
            <td colspan="2">
                ...
                <?php
               echo '
                <div id="guides" style="position:relative;background: white;border-radius:5px;padding-left: 13px;">
                <p><h3>Find it overwhelming? </h3>
                Check out our guide for setting up with Salesforce <a href="https://www.miniorange.com/step-by-step-guide-to-set-up-salesforce-as-idp-for-wordpress" target="_blank">here.</a></p>
                <p>Login into various Salesforce Communities using our Salesforce add-on, check out our detailed guide
                <a href="https://plugins.miniorange.com/setup-salesforce-using-miniorange-mo-authentication-selector-package" target="_blank">here</a>
                ...
                <hr>
                 ...
                 <p style="font-weight: normal">Provide this metadata URL to your Identity Provider or open it and save as .xml file to upload it in your idp:</p>
                        ...
                        <table border="1"
                            ...
                            <tr>
                                <td style="width:40%; padding: 15px;"><b>SP-EntityID / Issuer</b></td>
                                    ...
                                    <td style="width:60%; padding: 15px;font-weight: 400"><?php
    echo site_url() . '/wp-content/plugins/miniorange-saml-20-single-sign-on/';
    ?></td>
...
function mo_apps_config_saml()
{
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'upload_metadata') {
                ...
                <tr>
                    <td colspan="2" >
                        ...
                        <span style="position: relative;padding-bottom: 14px;padding-top:14px;background: white;border-radius: 10px; float:right;" id="upload-metadata" >
                            ...
                            <a href="<?php
        echo admin_url();
        ?>admin.php?page=mo_saml_settings&tab=save&action=upload_metadata" style="margin-left: 15px">
        ...
        ?>
                <?php
        if (!$idp_config && mo_is_customer_registered_saml()) {
            ?>
                    <!--<tr>
                    <td colspan="2"><div style="display:block;color:red;background-color:rgba(251, 251, 0, 0.43);padding:5px;border:solid 1px yellow;">You skipped a step. Please complete your Identity Provider configuration before you can enter the fields given below. If you have already completed your IdP configuration, please confirm on <a href="<?php
            //echo add_query_arg( array('tab' => 'config'), $_SERVER['REQUEST_URI'] );
            ?>">Configure Identity Provider</a> page to remove this warning.</div></td>
                </tr>-->
                <?php
        }
        ?>
        ...
        echo $saml_identity_name;
        ?>"
                               required <?php
        if (!mo_is_customer_registered_saml()) {
            echo 'disabled';
        }
        ?> title="Only alphabets, numbers and underscore is allowed"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
        ...
        ?>"
                            onclick="showTestWindow();" <?php
        if (!mo_is_sp_configured() || !get_option('saml_x509_certificate') || !mo_is_openssl_installed()) {
            echo 'disabled';
        }
        ?> value="Test configuration" class="button button-primary button-large"
                ...
                <tr>
                    ...
                    <td><br /><input type="button" name="saml_request" id="export-import-config"
                        ...
                        <?php
        if (!mo_is_sp_configured() || !get_option('saml_x509_certificate')) {
            echo 'disabled';
        }
        ...
        echo mo_get_test_url();
        ?>", "TEST SAML IDP", "scrollbars=1 width=800, height=600");
            }

            function showSAMLRequest() {
                var myWindow = window.open("<?php
        echo mo_get_saml_request_url();
        ?>", "VIEW SAML REQUEST", "scrollbars=1 width=800, height=600");
            }

            function showSAMLResponse() {
                var myWindow = window.open("<?php
        echo mo_get_saml_response_url();
        ?>", "VIEW SAML RESPONSE", "scrollbars=1 width=800, height=600");
            }
...
function mo_save_optional_config()
{
    ...
    ?>
                    <select id="saml_am_default_user_role" name="saml_am_default_user_role" <?php
    echo $disabled;
    ?>
                            style="width:150px;">
                        <?php
...
function mo_salesforce_enabled()
{
    if (is_multisite()) {
...
function mo_salesforce_download_logs($error_msg, $cause_msg)
{
...
function mo_salesforce_document_xml($saml)
{
    $doc = new DOMDocument();
...
function mo_support_saml()
{
    ...
    ?>"
                    ...
                    <tr>
                        <td><input type="tel" style="width:95%" id="contact_us_phone"
                                   ...
                                   value="<?php
    echo get_option('mo_saml_admin_phone');
    ?>"
    ...
    <?php
    mo_saml_keep_configuration_saml();
    ?>
...
function mo_salesforce_show_pricing_page()
{
    ?>
    <div class="mo_saml_table_layout">
        <h2>Licensing Plans
        ...
        <p>WordPress Multisite is a feature which allows users to create a “Network” of subsites within a single install of WordPress. This allows you to use subdomains (or subdirectories) of the same root domain (site1.domain.com as a subsite of domain.com for example), within the same Network.
            <b style="font-size: 16px">Currently you have Multisite <?php
    echo mo_saml_enabled();
    ?> on this instance.</b><p>
    ...
    echo mo_is_customer_registered_saml(false);
    ?>" id="mo_customer_registered">
        ...
        <form style="display:none;" id="loginform"
              action="<?php
    echo mo_options_plugin_constants::HOSTNAME . '/moas/login';
    ?>"
    ...
    ?>"/>
            <input type="text" name="redirectUrl"
                   value="<?php
    echo mo_options_plugin_constants::HOSTNAME . '/moas/initializepayment';
    ?>"/>
        ...
        <div hidden id="help_working_desc1" class="mo_saml_help_desc">
            ...
            <div style="display:block;text-align:center;">
                <img src="<?php
    echo plugin_dir_url(__FILE__) . 'images/saml_working.png';
    ?>"
...
function mo_salesforce_show_registeration_modal()
{
    $user = wp_get_current_user();
    ?>
    ...
    echo plugin_dir_url(__FILE__) . 'images/loadingbar.gif';
    ?>">
                        </div>
...
function mo_salesforce_generate_metadata()
{
...
function mo_saml_salesforce_display_sale_banner(){
    ?>
