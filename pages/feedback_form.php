...
function display_saml_feedback_form() {
	...
	wp_enqueue_style( 'mo_saml_admin_plugins_page_style', plugins_url( '/includes/css/style_settings.css?ver=4.8.60', __DIR__ ) );
	?>
    ...
    <script>
        jQuery('a[aria-label="Deactivate Login with Salesforce"]').click(function () {
