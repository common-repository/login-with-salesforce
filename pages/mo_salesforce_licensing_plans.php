...
function mo_show_licensing_page(){
                            ...
                            <div class="cd-pricing-body">
                                <ul class="cd-pricing-features">
                                    ...
                                    <li><b>Add-Ons</b><br />
                                       ...
                                       &nbsp;<br />Purchase Separately<br /><a style="color:blue;" href="<?php echo add_query_arg( array( 'tab' => 'support' ), htmlentities( $_SERVER['REQUEST_URI'] ) ); ?>"><b>Contact us</b></a><br />&nbsp;&nbsp;
                                    </li>
                                    <li>&nbsp;</li>
