...
class mo_login_wid extends WP_Widget
{
    public function __construct()
    {
        ...
        parent::__construct('Saml_Login_Widget', 'Login with ' . $identityName, array('description' => __('This is a miniOrange SAML login widget.', 'mosaml'), 'customize_selective_refresh' => true));
    }
    ...
    public function form($instance)
    {
        ...
        ?>
		<p><label for="<?php 
        echo $this->get_field_id('wid_title');
        ?>"><?php 
        _e('Title:');
        ?> </label>
        ...
        echo $this->get_field_id('wid_title');
        ?>" name="<?php 
        echo $this->get_field_name('wid_title');
        ?>" type="text" value="<?php 
        echo $wid_title;
        ?>" />
		</p>
    ...
    public function loginForm()
    {
		...
		<font size="+1" style="vertical-align:top;"> </font><?php 
            ...
            if (!$this->mo_salesforce_check_empty_or_null_val(get_option('mo_saml_redirect_error_code'))) {
		...
		<?php 
            ...
            ?>
		<?php 
            echo $link_with_username;
            ?> | <a href="<?php 
            echo wp_logout_url(mo_get_current_page_url());
            ?>" title="<?php 
            _e('Logout', 'mosaml');
            ?>"><?php 
            _e('Logout', 'mosaml');
    ...
    public function mo_salesforce_check_empty_or_null_val($value)
    {
...
function mo_login_validate()
{
    if (isset($_REQUEST['option']) && $_REQUEST['option'] == 'mosaml_metadata') {
        mo_salesforce_generate_metadata();
    }
