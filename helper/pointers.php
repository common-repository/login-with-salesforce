...
require_once dirname(__DIR__) . '/pages/mo_salesforce_settings_page.php';
...
if($tab == 'sp_metadata'){
    ...
    $pointers['miniorange-sp-metadata-guide'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Guides to help you setup' ) ),
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'We\'ve added detailed and easy to follow guides to setup Salesforce communities, check them out' ) ),
        'anchor_id' => '#guides',
        'edge'      => 'left',
        'align'     => 'left',
        'where'     => array( 'toplevel_page_mo_saml_settings' ) // <-- Please note this
    ...
    $pointers['metadata_manual'] = array(
        ...
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'If your IDP does not support metadata URL, you can even manually configure your IDP using the information given here' ) ),
